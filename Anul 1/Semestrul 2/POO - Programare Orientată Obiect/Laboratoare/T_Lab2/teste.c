...
void test_functionalitati_service() 
{
	...
	// filtrare
	static ListaMasini filtrate;
	filtrate = filtrare_dupa_model(&l, "Audi");
	assert(filtrate.nr_masini == 2);
	assert(strcmp(filtrate.masini[0].model, "Audi") == 0);

	// sortare
	static ListaMasini sortate;
	sortate = dupa_model_crescator(&l);
...
void test_dupa_model_descrescator()
{
	...
	static ListaMasini sortate;
	sortate = dupa_model_descrescator(&l);
...
void test_dupa_categorie_crescator()
{
	...
	static ListaMasini sortate;
	sortate = dupa_categorie_crescator(&l);
...
void test_dupa_categorie_descrescator()
{
	...
	static ListaMasini sortate;
	sortate = dupa_categorie_descrescator(&l);
